...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    dataloader, dataset = create_dataloader(train_path, imgsz, batch_size, gs, opt,
                                            ...
                                            rank=rank, world_size=opt.world_size, workers=opt.workers,channels=model.channels)
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(test_path, imgsz_test, batch_size*2, gs, opt,
                                       ...
                                       rank=-1, world_size=opt.world_size, workers=opt.workers,channels=model.channels)[0]  # testloader
